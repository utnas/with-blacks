...
public class UserDtoBuilder {
    ...
    public static UserDto build(final long id, final String firstName, final String lastName, final GENDER gender) {
        // catch errors here
        return new UserDto(id, firstName, lastName, gender);
    }
